    ...
    var readFile = function(path, callback) {
        ...
        if(ext === "yaml") {
            try{
                ...
                console.log("Done loading YAML file: " + path)
            } catch(err) {
            ...
            try{
                ...
                console.log("Done loading JSON file: " + path)
            } catch(err) {
    ...
    if(!path) {
        if(CACHED_RULE_PATH) {
            ...
            if(fs.existsSync(fsPath.join(process.cwd(), DEFAULT_RULES_FILE_YAML))) {
                ...
                console.error("Could not load any default rules file. Please create one or specify a rules file with --rule param.");
                callback((new Error("Could not load any default rules file. Please create one or specify a rules file with --rule param.")),{});
                return
            }
        }
    }
